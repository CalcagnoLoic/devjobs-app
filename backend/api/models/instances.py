...
blogrOffer = Offer(
    ...
    "https://example.com/blogr/apply",
    "https://example.com/blogr",
    "./public/assets/img/logos/blogr.svg",
    "hsl(12, 79%, 52%)",
)
blogrRequirements = Requirements(
    2,
...
vectorOffer = Offer(
    ...
    "https://example.com/vector/apply",
    "https://example.com/vector",
    "./public/assets/img/logos/vector.svg",
    "hsl(235, 10%, 23%)",
)
vectorRequirements = Requirements(
    3,
...
officeLiteOffer = Offer(
    ...
    "https://example.com/officelite/apply",
    "https://example.com/officelite",
    "./public/assets/img/logos/officelite.svg",
    "hsl(227, 62%, 48%)",
)
officeLiteRequirements = Requirements(
    4,
...
podOffer = Offer(
    ...
    "https://example.com/pod/apply",
    "https://example.com/pod",
    "./public/assets/img/logos/pod.svg",
    "hsl(216, 46%, 14%)",
)
...
creativeOffer = Offer(
    ...
    "https://example.com/creative/apply",
    "https://example.com/creative",
    "./public/assets/img/logos/creative.svg",
    "hsl(295, 55%, 21%)",
)
...
pomodoroOffer = Offer(
    ...
    "https://example.com/pomodoro/apply",
    "https://example.com/pomodoro",
    "./public/assets/img/logos/pomodoro.svg",
    "hsl(254, 71%, 45%)",
)
pomodoroRequirements = Requirements(
    7,
...
makerOffer = Offer(
    ...
    "https://example.com/maker/apply",
    "https://example.com/maker",
    "./public/assets/img/logos/maker.svg",
    "hsl(218, 58%, 31%)",
)
makerRequirements = Requirements(
    8,
...
coffeeroastersOffer = Offer(
    ...
    "https://example.com/coffeeroasters/apply",
    "https://example.com/coffeeroasters",
    "./public/assets/img/logos/coffeeroasters.svg",
    "hsl(29, 60%, 87%)",
)
coffeeroastersRequirements = Requirements(
    9,
...
mastercraftOffer = Offer(
    ...
    "https://example.com/mastercraft/apply",
    "https://example.com/mastercraft",
    "./public/assets/img/logos/mastercraft.svg",
    "hsl(0, 0%, 12%)",
)
mastercraftRequirements = Requirements(
    10,
...
crowdfundOffer = Offer(
    ...
    "https://example.com/crowdfund/apply",
    "https://example.com/crowdfund",
    "./public/assets/img/logos/crowdfund.svg",
    "hsl(157, 57%, 50%)",
)
crowdfundRequirements = Requirements(
    11,
...
typemasterOffer = Offer(
    ...
    "https://example.com/typemaster/apply",
    "https://example.com/typemaster",
    "./public/assets/img/logos/typemaster.svg",
    "hsl(22, 89%, 52%)",
)
typemasterRequirements = Requirements(
    12,
...
crowdfundRequirements2 = Requirements(
    13,
...
coffeeroastersRequirements2 = Requirements(
    14,
...
blogrRequirements2 = Requirements(
    15,
